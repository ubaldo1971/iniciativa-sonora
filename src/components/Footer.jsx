            ...
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="mb-6">
                            <img src="/logo.png" alt="Iniciativa Sonora" className="h-20 w-auto" />
                        </div>
                        ...
                        <div className="flex gap-4">
                            <a
                                href="https://www.youtube.com/@Iniciativa_SON"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-blue-800 flex items-center justify-center hover:bg-white hover:text-primary transition-colors"
                                title="YouTube"
                            >
                            ...
                            <a
                                href="https://x.com/Iniciativa_SON"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-blue-800 flex items-center justify-center hover:bg-white hover:text-primary transition-colors"
                                title="X (Twitter)"
                            ...
                            <a
                                href="https://www.instagram.com/iniciativa_son/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-blue-800 flex items-center justify-center hover:bg-white hover:text-primary transition-colors"
                                title="Instagram"
                            ...
                            <a
                                href="https://www.tiktok.com/@iniciativa_son"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-blue-800 flex items-center justify-center hover:bg-white hover:text-primary transition-colors"
                                title="TikTok"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['Inicio', 'Nosotros', 'Servicios', 'Proyectos', 'Contacto'].map((item) => (
                                <li key={item}>
                                    <a href={`#${item.toLowerCase()}`} className="text-blue-100 hover:text-white transition-colors">
                                        {item}
                                    </a>
                                </li>
                            ))}
